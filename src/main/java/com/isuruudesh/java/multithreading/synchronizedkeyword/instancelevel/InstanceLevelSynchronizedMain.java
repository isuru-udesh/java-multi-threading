...
public class InstanceLevelSynchronizedMain {
    public static void main(String[] args) {
        ...
        var thread1 = new Thread(() -> {
            for (int i = 0; i < 10000; i++) {
                ...
                instanceSynchronized.incrementCount();
            }
            System.out.println("Count from thread 1 : " + instanceSynchronized.getCount());
        });
        ...
        var thread2 = new Thread(() -> {
            ...
            System.out.println("Count from thread 2 : " + instanceSynchronized.getCount());
        });
        thread1.start();
        thread2.start();
    }
